...
insert into Passengers (first_name, last_name, date_of_birth, user_name, password, admin) values ('Anna', 'Orbók', '1977-03-27', 'orboka@gmail.com', 'Tündérgalambocska79', false);
...
insert into Tickets (flight_number, departure_date, departure_place, arrival_date, arrival_place, passenger_id, price, deleted)
values('AF546', now(), 'Budapest', now(), 'Frankfurt', (select id from Passengers where first_name = 'Anna' and last_name = 'Orbók'), 18500, false);